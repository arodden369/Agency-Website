...
export function Navbar() {
  ...
  const navLinks = [
    ...
    { name: "With Us vs. Without Us", href: "#difference" },
    { name: "Results", href: "#results" },
    { name: "FAQ", href: "#guarantee-contact" },
  ]
    ...
    >
      ...
      >
        <Link href="/" className="text-2xl font-bold tracking-tighter relative z-50">
          GrounderAI<span className="text-blue-400">.</span>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a
            ...
            className="bg-white text-black px-5 py-2 rounded-full text-sm font-semibold hover:bg-white/90 transition-colors relative z-50 pointer-events-auto"
          >
            Book a Call
          </a>
        </div>
          ...
          >
            <div className="flex flex-col items-center gap-8">
              ...
              <a
                ...
                rel="noopener noreferrer"
                onClick={() => setIsMobileMenuOpen(false)}
                className="mt-4 bg-white text-black px-8 py-3 rounded-full text-lg font-semibold relative z-50 pointer-events-auto"
              >
                Book a Call
              </a>
            </div>
